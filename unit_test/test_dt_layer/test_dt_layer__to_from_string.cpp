...
void	test_dt_layer__to_from_string_path1()
{
	...
	const	string	s = layer1.to_string();

	ofstream	ofs("../../for_test/out/" __FUNCTION__ ".mydlayer");
	ofs	 << s << endl;
	ofs.close();

	dt_layer	layer2;
	layer2.from_string(s);


	CU_ASSERT_EQUAL(layer1, layer2);
	CU_ASSERT_EQUAL(layer1.to_string(), layer2.to_string());
}

//void	test_dt_layer__to_from_string_text1()
//{
//	const	dt_obj		obj_text(create_text());
//
//	dt_group	gr1;
...
//}
//
//void	test_dt_layer__to_from_string_path1_text1()
//{
//	const	dt_obj		obj_path(create_path());
//	const	dt_obj		obj_text(create_text());
//
...
//}
//
//void	test_dt_layer__to_from_string_path2()
//{
//	const	dt_obj		obj_path(create_path());
//
//	dt_group	gr1;
...
//}
//
//void	test_dt_layer__to_from_string_text2()
//{
//	const	dt_obj		obj_text(create_text());
//
//	dt_group	gr1;
...
//}
//
//void	test_dt_layer__to_from_string_path2_text2()
//{
//	const	dt_obj		obj_path(create_path());
//	const	dt_obj		obj_text(create_text());
//
...
//}
//
//void	test_dt_layer__to_from_string_path1000_text1000()
//{
//	dt_group	gr1;
//
